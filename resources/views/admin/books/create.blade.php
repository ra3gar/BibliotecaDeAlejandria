...
<div class="max-w-3xl lib-animate">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <p class="text-xs text-sepia-400 uppercase tracking-wider">Libros</p>
            <h2 class="text-lg font-serif font-semibold text-mahogany-900 leading-tight">Nuevo Libro</h2>
        </div>
    </div>
    ...
    <div class="bg-parchment-50 border border-parchment-300 rounded-2xl shadow-sm p-7">
        <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3 mt-7 pt-6 border-t border-parchment-300">
                ...
                <a href="{{ route('admin.books.index') }}" class="btn-ghost">Cancelar</a>
            </div>
        </form>
    </div>
</div>
