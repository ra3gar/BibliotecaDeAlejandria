...
<div class="max-w-xl lib-animate">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <p class="text-xs text-sepia-400 uppercase tracking-wider">Autores</p>
            <h2 class="text-lg font-serif font-semibold text-mahogany-900 leading-tight">{{ $author->full_name }}</h2>
        </div>
    </div>
    ...
    <div class="bg-parchment-50 border border-parchment-300 rounded-2xl shadow-sm p-7">
        <form method="POST" action="{{ route('admin.authors.update', $author) }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3 mt-7 pt-6 border-t border-parchment-300">
                ...
                <a href="{{ route('admin.authors.index') }}" class="btn-ghost">Cancelar</a>
            </div>
        </form>
    </div>
</div>
